            ...
            <div className="bg-white text-gray-800 p-6 md:p-12">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-6 flex flex-col items-center md:flex-row md:items-start">
                        <img src={logo} alt="Company Image" className="w-48 h-48 object-cover mb-4 md:mr-6 md:mb-0" />
                        <div className="flex flex-col">
                            <h1 className="text-4xl md:text-6xl font-bold text-green-700 mb-2">Poshinda.co</h1>
                            <div className="font-bold text-xl md:text-3xl">The Pure Essence of Nature & Soil</div>
                        </div>
                    </div>
                    ...
                    <div className="mt-8">
                        <h2 className="text-3xl font-semibold text-center md:text-left text-green-700 mb-4">Our Founders</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="flex flex-col items-center bg-gray-100 p-4 rounded-lg shadow-lg">
                                ...
                                <h3 className="text-xl font-bold text-green-700 text-center">Mr. Ashish Kumbhare</h3>
                                <p className="text-center">Co-Founder & Chief Executive Officer (CEO)</p>
                            </div>
                            <div className="flex flex-col items-center bg-gray-100 p-4 rounded-lg shadow-lg">
                                <img src={founder1} alt="Founder 1" className="w-32 h-32 object-cover rounded-full mb-4" />
                                <h3 className="text-xl font-bold text-green-700 text-center">Mr. Homraj Jambhulkar</h3>
                            ...
                            <div className="flex flex-col items-center bg-gray-100 p-4 rounded-lg shadow-lg">
                                ...
                                <h3 className="text-xl font-bold text-green-700 text-center">Mr. Vaibhav Jambhulkar</h3>
                            ...
                            <div className="flex flex-col items-center bg-gray-100 p-4 rounded-lg shadow-lg">
                                ...
                                <h3 className="text-xl font-bold text-green-700 text-center">Mr. Harish Ukare</h3>
